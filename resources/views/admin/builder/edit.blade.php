...
@section('tbody')
    <tr>
        ...
        <th>
            <input name="description" type="text" placeholder="description" value="{{ $build->product->description }}">
        </th>
        <th>
            <input name="quantity" type="text" placeholder="quantity" value="{{ $build->product->quantity }}">
        </th>
        <th>
            <input name="price" type="text" placeholder="price" value="{{ $build->product->price }}">
        </th>
        <th>
            <input name="image" type="file" placeholder="image">
        </th>
        <th>
            <input name="realese_date" type="date" placeholder="realese_date" value="{{ $build->product->realese_date }}">
        </th>
        <th>
            <input name="visibility" type="text" placeholder="visibility" value="{{ $build->product->visibility }}">
        </th>
        <th>
